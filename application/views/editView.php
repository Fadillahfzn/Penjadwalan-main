...
<body>
    <div class="ml-5 mt-5 mb-5">
        ...
        <form method="POST" action="<?= base_url('/Stella/update') ?>" class="border border-primary rounded px-5 py-5 mx-auto" style="width: 50%;">
            <div class="form-group">
                <label>Kode Matakuliah</label>
                <input type="text" class="form-control" placeholder="KP01" name="kodemtk" value="<?= $jadwal->kodemtk; ?>" required autocomplete="off" disabled>
            </div>
            <div class="form-group">
